...
# https://www.data-to-viz.com/ gives you suggestions based on the type of data, plus code and advice. Super useful.
...
# The second line says what kind of viz you want. 
# Syntax is
...
# Add dollar signs and commas to the axis labels.
...
# Again I can add dollar sign and commas to make y axis easier to read
...
# Could there be a relationship? It's possible to make this base R look better and add a regression line, but I tend to do that work in ggplot.
...
# A little hard to see with the grey background, I'll change the theme to get rid of the grid lines altogether and bump up the dot size a bit
...
# If you want to learn more about plotly and R:
# https://plot.ly/r/
...
# It can be helpful for the viewer to re-order the bars from large to small. You can make this a code snippet, too.
